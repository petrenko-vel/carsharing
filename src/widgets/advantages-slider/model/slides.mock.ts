...
export const advantagesData: AdvantageSlide[] = [
  ...
  },
  {
    ...
    menuLabel: 'СТРАХОВКА',
    description:
      'Полная страховка и КАСКО уже в тарифе. Пользуйтесь каршерингом без лишних расходов и бумажной волокиты.',
    buttonText: 'Подробнее',
    buttonHref: '#',
    image: slideTwo,
    buttonGradient: 'blue',
  },
  {
    ...
    menuLabel: 'БЕНЗИН',
    description:
      'Мы оплачиваем топливо. Просто выбирайте ближайшую машину, открывайте приложение и отправляйтесь в поездку.',
    buttonText: 'Подробнее',
    buttonHref: '#',
    image: slideThree,
    buttonGradient: 'red',
  },
  {
    ...
    description:
      'Служба поддержки всегда на связи. Поможем с любым вопросом: от бронирования до завершения аренды.',
    buttonText: 'Подробнее',
    buttonHref: '#',
    image: slideFour,
